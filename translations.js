    ...
    constructor() {
        this.translations = {
            es: {
                ...
                'profile.neighbors.sendEmail': 'Enviar correo',
                'profile.neighbors.emailSending': 'Enviando...',
                'profile.neighbors.emailSent': 'Email enviado correctamente',
                'profile.neighbors.emailError': 'No se pudo enviar el email',
            ...
            en: {
                ...
                'profile.neighbors.sendEmail': 'Send email',
                'profile.neighbors.emailSending': 'Sending...',
                'profile.neighbors.emailSent': 'Email sent successfully',
                'profile.neighbors.emailError': 'We couldn\'t send the email',
            ...
            fr: {
                ...
                'profile.neighbors.sendEmail': 'Envoyer un email',
                'profile.neighbors.emailSending': 'Envoi en cours...',
                'profile.neighbors.emailSent': 'Email envoyé avec succès',
                'profile.neighbors.emailError': 'Impossible d\'envoyer l\'email',
            ...
            de: {
                ...
                'profile.neighbors.sendEmail': 'Email senden',
                'profile.neighbors.emailSending': 'Wird gesendet...',
                'profile.neighbors.emailSent': 'Email erfolgreich gesendet',
                'profile.neighbors.emailError': 'Email konnte nicht gesendet werden',
